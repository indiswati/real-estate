      ...
      >
        <form className="p-6 space-y-5" onSubmit={handleSubmit} noValidate>
          ...
          <div style={{ transform: "none" }}>
            <select
              name="role"
              className="w-full px-4 py-4 rounded-lg border border-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
              value={formData.role}
              onChange={handleChange}
            >
              ...
              <option value="broker" className="text-gray-800">
                Broker / Agent
              </option>
              <option value="developer" className="text-gray-800">
                Builder / Developer
              </option>
              <option value="investor" className="text-gray-800">
                Property Investor
              </option>
              <option value="consultant" className="text-gray-800">
          ...
          <div>
            ...
            >
              ...
              <option value="buyer-leads" className="text-gray-800">
                Buyer Leads
              </option>
              <option value="seller-leads" className="text-gray-800">
                Seller Leads
              </option>
              <option value="broker" className="text-gray-800">
                Broker Network
              </option>
              <option value="appointment" className="text-gray-800">
                Appointment Setting
              </option>
            </select>
          </div>
