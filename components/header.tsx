    ...
    <header className="bg-white/90 backdrop-blur-md shadow-lg sticky top-0 z-50" style={{ transform: "none" }}>
      <div className="max-w-[1365px] mx-auto flex justify-between items-center p-4 relative">
        ...
        <nav className="space-x-6 hidden md:flex items-center">
          ...
          <button
            className="hover:text-blue-600 transition-colors duration-300 cursor-pointer"
            style={{ transform: "none" }} onClick={() => scrollToElement('about')}
          >
            About Us
          </button>
          ...
          <button
            className="hover:text-blue-600 transition-colors duration-300 cursor-pointer"
            style={{ transform: "none" }} onClick={() => scrollToElement('blog')}
          >
            Blog
          </button>
          <button
            className="hover:text-blue-600 transition-colors duration-300 cursor-pointer"
            style={{ transform: "none" }} onClick={() => scrollToElement('contact')}
          >
            Contact
          </button>
        ...
        <button className="md:hidden text-2xl" tabIndex={0}>
          ☰
        </button>
      </div>
    </header>
